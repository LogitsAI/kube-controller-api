...
/*
Join builds a name by concatenating a number of parts with '-' as
...
For example: Join(cons, "a-b", "c") != Join(cons, "a", "b-c")
...
*/
func Join(cons Constraints, parts ...string) string {
	return JoinSalt(cons, nil, parts...)
}

// JoinSalt works like Join except the appended
...
// pay attention to.
func JoinSalt(cons Constraints, salt []string, parts ...string) string {
